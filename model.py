...
class tb_bloodpresure(db.Model):
	...
	SBP = db.Column(db.String(16))
	DBP = db.Column(db.String(16))
	MBP = db.Column(db.String(16))
...
class tb_bloodsugar(db.Model):
	...
	auditDoctorEMPI = db.Column(db.String(255))
	auditDoctorName = db.Column(db.String(255))
	fastingBloodGlucose = db.Column(db.String(16))
	conclusion = db.Column(db.String(512))
	uploadTime = db.Column(db.DateTime, default=datetime.now())
...
class tb_bwh(db.Model):
	...
	auditDoctorEMPI = db.Column(db.String(255))
	auditDoctorName = db.Column(db.String(255))
	hip = db.Column(db.String(16))
	bust = db.Column(db.String(16))
	waist = db.Column(db.String(16))
	conclusion = db.Column(db.String(512))
	uploadTime = db.Column(db.DateTime, default=datetime.now())
...
class tb_ecg(db.Model):
	...
	auditDoctorEMPI = db.Column(db.String(255))
	auditDoctorName = db.Column(db.String(255))
	HR = db.Column(db.String(16))
	PR = db.Column(db.String(16))
	P_Duration = db.Column(db.String(16))
	T_Duration = db.Column(db.String(16))
	QT_Duration = db.Column(db.String(16))
	QTc_Duration = db.Column(db.String(16))
	P_Axis = db.Column(db.String(16))
	R_V5 = db.Column(db.String(16))
	S_V1 = db.Column(db.String(16))
	conclusion = db.Column(db.String(512))
	uploadTime = db.Column(db.DateTime, default=datetime.now())
...
class tb_heighweight(db.Model):
	...
	auditDoctorEMPI = db.Column(db.String(255))
	auditDoctorName = db.Column(db.String(255))
	heigh = db.Column(db.String(16))
	weight = db.Column(db.String(16))
	bmi = db.Column(db.String(16))
	conclusion = db.Column(db.String(512))
	uploadTime = db.Column(db.DateTime, default=datetime.now())
